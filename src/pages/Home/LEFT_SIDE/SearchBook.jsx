...
const SearchBook = () => {
    ...
    return (
        <>
            ...
            <div className='w-full flex flex-col gap-2 p-2 pb-10 mt-2 h-[90%] relative bg-slate-500 rounded-xl'>
                ...
                <div onClick={() => setShowAll(!showAll)} className='absolute top-[82%] right-3 cursor-pointer bg-slate-800 rounded-full border-2 border-white p-2'>
