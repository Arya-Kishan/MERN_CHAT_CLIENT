...
const OtherUsers = () => {
    ...
    return (
        <div className='h-full p-1 overflow-auto flex justify-evenly items-center gap-1 relative'>
            ...
            <div className='absolute bottom-0 left-0 w-full md:static md:w-[20%] h-fit md:h-full flex md:flex-col items-center justify-evenly bg-slate-950 z-10 p-2'><Navbar setShow={setShow} /></div>

            <div className='w-full md:w-[80%] h-full bg-slate-800'>
